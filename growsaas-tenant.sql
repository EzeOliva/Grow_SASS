...
-- ----------------------------
INSERT INTO `feedback_queries` VALUES (1, 'NPS', 'En una escala del 0 al 10, ¿qué probabilidad hay de que recomiende nuestro producto/servicio a un amigo o colega?', NULL, 1, 10, 1.00, '2025-06-23 18:53:32', '2025-06-23 18:53:32');
INSERT INTO `feedback_queries` VALUES (2, 'CSAT', '¿Qué tan satisfecho está con su experiencia reciente con nuestro servicio?', NULL, 2, 5, 1.00, '2025-06-23 18:54:00', '2025-06-23 18:54:00');
INSERT INTO `feedback_queries` VALUES (3, 'CES', '¿Qué tan fácil le parece que resolvemos sus consulta o requerimientos?', NULL, 1, 7, 1.00, '2025-06-23 18:54:26', '2025-06-23 18:54:26');
INSERT INTO `feedback_queries` VALUES (4, 'TTR', '¿Qué tan conforme está con el tiempo en que respondemos a sus consulta o requerimientos?', NULL, 1, 7, 1.00, '2025-06-23 18:54:26', '2025-06-23 18:54:26');
...
(1, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'yes', 'team', 'Administrator', 3, 4, 3, 3, 3, 4, 3, 3, 3, 'global', 3, 'global', '2', 3, 'global', 3, 'global', 3, 'global', 3, 'global', 3, 3, 'yes', 'yes', 'yes', 'yes', 'yes', '3', '3', '3', '3', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'yes', 'global', '[]', 1, 2),
(3, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Técnico', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(2, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'yes', 'client', 'Client', 0, 3, 1, 1, 1, 0, 1, 0, 1, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 1, 'own', 1, 'global', 2, 1, 'no', 'no', 'no', 'no', 'no', '1', '0', '0', '0', 'no', 'no', '3', 'dashboard', 'yes', 'no', 'yes', 'own', '[]', 2, 1),
(4, '2025-07-02 17:28:39', '2025-07-02 20:21:03', 'no', 'team', 'Supervisor', 1, 1, 0, 0, 0, 0, 0, 0, 2, 'global', 2, 'own', '0', 0, 'own', 0, 'own', 2, 'global', 1, 'global', 0, 1, 'no', 'yes', 'no', 'yes', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'no', 'global', '[]', 2, 1),
(5, '2025-07-02 20:12:49', '2025-07-02 20:21:03', 'no', 'team', 'Staff', 2, 2, 0, 0, 0, 0, 0, 0, 2, 'global', 2, 'own', '0', 0, 'own', 0, 'own', 2, 'global', 3, 'global', 0, 2, 'no', 'yes', 'no', 'yes', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'no', 'global', '[]', 2, 1),
(6, '2025-07-02 20:15:25', '2025-07-02 20:21:03', 'no', 'team', 'Comercial', 1, 0, 3, 3, 3, 3, 3, 3, 0, 'own', 0, 'own', '0', 3, 'global', 3, 'global', 0, 'own', 0, 'global', 0, 1, 'no', 'no', 'yes', 'no', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'no', 'global', '[]', 2, 1),
(7, '2025-07-02 20:16:23', '2025-07-02 20:21:03', 'no', 'team', 'Vendedor', 0, 0, 0, 0, 0, 0, 0, 0, 0, 'own', 0, 'own', '0', 3, 'own', 0, 'own', 0, 'own', 0, 'global', 0, 0, 'no', 'no', 'yes', 'no', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(8, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Chofer', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(9, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Personal limpieza', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(10, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Docentes', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(11, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Secretario', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(12, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Custodio', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(13, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Repositor', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1),
(14, '2025-07-02 20:25:58', '2025-07-02 20:26:02', 'no', 'team', 'Contador', 2, 1, 0, 3, 0, 0, 3, 3, 0, 'own', 0, 'own', '0', 0, 'own', 3, 'global', 0, 'global', 0, 'global', 0, 0, 'no', 'no', 'no', 'no', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'no', 'global', '[]', 2, 1),
(15, '2025-07-02 20:28:18', '2025-07-02 20:30:02', 'no', 'team', 'RRHH', 2, 2, 0, 0, 0, 0, 0, 0, 3, 'own', 3, 'global', '0', 0, 'global', 0, 'own', 3, 'global', 3, 'global', 2, 2, 'no', 'yes', 'no', 'yes', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'no', 'global', '[]', 2, 1),
(16, '2025-07-02 20:29:30', '2025-07-02 20:30:02', 'no', 'team', 'Soporte', 1, 1, 0, 0, 0, 0, 0, 0, 2, 'global', 0, 'own', '0', 0, 'own', 0, 'own', 0, 'own', 0, 'global', 3, 2, 'no', 'no', 'no', 'no', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'yes', 'global', '[]', 2, 1),
(17, '2025-07-02 20:12:49', '2025-07-02 20:21:03', 'no', 'team', 'Customer Success', 2, 2, 0, 0, 0, 0, 0, 0, 2, 'global', 2, 'own', '0', 0, 'own', 0, 'own', 2, 'global', 3, 'global', 0, 2, 'no', 'yes', 'no', 'yes', 'no', '0', '1', '1', '1', 'yes', 'yes', '3', 'dashboard', 'yes', 'yes', 'no', 'global', '[]', 2, 1),
(18, '2018-09-07 14:49:41', '2025-07-02 20:21:03', 'no', 'team', 'Colaborador', 1, 1, 0, 0, 0, 0, 0, 0, 3, 'own', 1, 'own', '0', 0, 'own', 0, 'own', 2, 'own', 0, 'global', 0, 1, 'no', 'no', 'no', 'no', 'no', '0', '0', '0', '0', 'yes', 'yes', '3', 'dashboard', 'yes', 'no', 'no', 'global', '[]', 2, 1);
...
(1, NULL, '2025-04-10 16:54:27', '2025-04-10 16:54:27', NULL, 1, 'admin@example.com', '$2y$10$iTsSjhyjWNdjECnmDM8/w.xUUAmeKlmrdDWdg4F5TAjrlWh.WBWFG', 'John', 'Doe', NULL, NULL, NULL, 'no', 'yes', NULL, NULL, 'team', 'active', 1, '2025-04-10 16:54:27', 'default', NULL, NULL, NULL, NULL, NULL, NULL, 'english', 'yes', 'collapsed', 'collapsed', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'kanban', 'kanban', 'list', 'default', 'due', 'due', 'due', 'all', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, 'disabled', NULL, NULL, NULL, 'no', 'yes_email', 'no', 'yes_email', 'yes_email', 'yes_email', 'yes_email', 'yes_email', 'yes_email', 'yes_email', 'yes', 'no', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `feedback_queries`
  MODIFY `feedback_query_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Client Success extensions (Etapas, Minutas, Capacitaciones)
-- Fecha: 31-03-2026
--

ALTER TABLE `clients`
  ADD COLUMN IF NOT EXISTS `client_stage_id` int(11) DEFAULT NULL AFTER `client_module_feedback`;

CREATE TABLE IF NOT EXISTS `client_stages` (
  `client_stage_id` int(11) NOT NULL AUTO_INCREMENT,
  `client_stage_title` varchar(190) NOT NULL,
  `client_stage_description` text DEFAULT NULL,
  `client_stage_position` int(11) NOT NULL DEFAULT 1,
  `client_stage_active` varchar(10) NOT NULL DEFAULT 'yes',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`client_stage_id`),
  KEY `client_stage_position` (`client_stage_position`),
  KEY `client_stage_active` (`client_stage_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

CREATE TABLE IF NOT EXISTS `client_stage_histories` (
  `client_stage_history_id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`client_stage_history_id`),
...
CREATE TABLE IF NOT EXISTS `client_minutas` (
  `client_minuta_id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  `minuta_date` date NOT NULL,
  `minuta_detail` text NOT NULL,
  `minuta_creatorid` int(11) DEFAULT NULL,
  `minuta_created` datetime DEFAULT NULL,
  `minuta_updated` datetime DEFAULT NULL,
  PRIMARY KEY (`client_minuta_id`),
  KEY `client_id` (`client_id`),
  KEY `minuta_date` (`minuta_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

CREATE TABLE IF NOT EXISTS `client_capacitaciones` (
  `client_capacitacion_id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  `capacitacion_date` date NOT NULL,
  `capacitacion_mode` varchar(50) NOT NULL,
  `capacitacion_participants` varchar(500) NOT NULL,
  `capacitacion_topics` text NOT NULL,
  `capacitacion_observations` text DEFAULT NULL,
  `capacitacion_creatorid` int(11) DEFAULT NULL,
  `capacitacion_created` datetime DEFAULT NULL,
  `capacitacion_updated` datetime DEFAULT NULL,
  PRIMARY KEY (`client_capacitacion_id`),
  KEY `client_id` (`client_id`),
  KEY `capacitacion_date` (`capacitacion_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Seed default stages only when table is empty
INSERT INTO `client_stages` (`client_stage_title`, `client_stage_description`, `client_stage_position`, `client_stage_active`, `created_at`, `updated_at`)
SELECT 'Implementación', 'Puesta en marcha de la solución, configuración inicial, carga de datos y capacitación básica.', 1, 'yes', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM `client_stages` LIMIT 1);

INSERT INTO `client_stages` (`client_stage_title`, `client_stage_description`, `client_stage_position`, `client_stage_active`, `created_at`, `updated_at`)
SELECT 'Adopción', 'El cliente usa el sistema de forma frecuente, incorpora buenas prácticas y consolida procesos.', 2, 'yes', NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM `client_stages` WHERE `client_stage_title` = 'Implementación')
  AND NOT EXISTS (SELECT 1 FROM `client_stages` WHERE `client_stage_title` = 'Adopción');

INSERT INTO `client_stages` (`client_stage_title`, `client_stage_description`, `client_stage_position`, `client_stage_active`, `created_at`, `updated_at`)
SELECT 'Expansión', 'Se amplía el alcance del uso, se suman equipos o módulos y se buscan oportunidades de crecimiento.', 3, 'yes', NOW(), NOW()
WHERE EXISTS (SELECT 1 FROM `client_stages` WHERE `client_stage_title` = 'Implementación')
  AND NOT EXISTS (SELECT 1 FROM `client_stages` WHERE `client_stage_title` = 'Expansión');
