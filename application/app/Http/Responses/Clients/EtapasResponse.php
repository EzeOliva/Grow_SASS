...
class EtapasResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $html = view('pages/client/components/tabs/etapas', compact('page', 'client', 'tags', 'stages', 'history'))->render();
        $jsondata['dom_html'][] = [
