...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-6 text-right">
            <a href="{{ route('whatsapp.connections.show', $connection) }}" class="btn btn-outline-info">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        ...
                        Edit Connection: {{ $connection->connection_name }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('whatsapp.connections.update', $connection) }}" method="POST" id="connection-edit-form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('connection_name', $connection->connection_name) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('connection_type') is-invalid @enderror" 
                                        ...
                                        <option value="baileys" {{ old('connection_type', $connection->connection_type) == 'baileys' ? 'selected' : '' }}>Baileys (WhatsApp Web)</option>
                                        <option value="twilio" {{ old('connection_type', $connection->connection_type) == 'twilio' ? 'selected' : '' }}>Twilio</option>
                                        <option value="360dialog" {{ old('connection_type', $connection->connection_type) == '360dialog' ? 'selected' : '' }}>360dialog</option>
                                        <option value="gupshup" {{ old('connection_type', $connection->connection_type) == 'gupshup' ? 'selected' : '' }}>Gupshup</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('connection_data.account_sid', $connection->connection_data['account_sid'] ?? '') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" 
                                               ...
                                               value="{{ old('connection_data.auth_token', $connection->connection_data['auth_token'] ?? '') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('connection_data.api_key', $connection->connection_data['api_key'] ?? '') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" 
                                               ...
                                               value="{{ old('connection_data.webhook_secret', $connection->connection_data['webhook_secret'] ?? '') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('connection_data.app_name', $connection->connection_data['app_name'] ?? '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" 
                                           ...
                                           value="{{ old('webhook_config.webhook_url', $connection->webhook_config['webhook_url'] ?? '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" 
                                           ...
                                           value="{{ old('webhook_config.webhook_secret', $connection->webhook_config['webhook_secret'] ?? '') }}"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('whatsapp.connections.show', $connection) }}" class="btn btn-outline-secondary">
