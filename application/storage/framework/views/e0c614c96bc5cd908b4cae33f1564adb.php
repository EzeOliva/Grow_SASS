    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="r-panel-body">
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.health_status'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_health_status[]" id="filter_health_status"
                                    class="form-control form-control-sm select2-basic select2-multiple"
                                    multiple="multiple" tabindex="-1" aria-hidden="true">
                                    <option value="green"><?php echo e(cleanLang(__('lang.green'))); ?></option>
                                    <option value="yellow"><?php echo e(cleanLang(__('lang.yellow'))); ?></option>
                                    <option value="red"><?php echo e(cleanLang(__('lang.red'))); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.average_feedback'))); ?>
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.expectation_fulfillment'))); ?>
...
<!--sidebar--><?php /**PATH D:\Grow_SaaS\application\resources\views/pages/clients/components/misc/filter-clients.blade.php ENDPATH**/ ?>