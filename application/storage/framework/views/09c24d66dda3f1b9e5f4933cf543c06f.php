...
<div class="container-fluid">
	<div class="row page-titles mb-4">
		...
		<div class="col-md-6 text-end">
			<a href="<?php echo e(route('whatsapp.connections.create')); ?>" class="btn btn-primary btn-lg shadow-sm">
			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 text-end">
					<span class="badge bg-light text-dark fs-6 px-3 py-2">
						<i class="fas fa-info-circle me-1"></i><?php echo e(isset($connections) ? $connections->count() : 0); ?> Connections
					</span>
				</div>
			</div>
		</div>
		<div class="card-body p-0">
			<?php if(isset($connections) && $connections->count()): ?>
								...
								<tr class="border-bottom">
									<td class="py-3 px-4">
										<div class="d-flex align-items-center">
											...
											<div>
												<h6 class="text-dark fw-semibold mb-1"><?php echo e($connection->connection_name); ?></h6>
												<small class="text-muted">
													<i class="fas fa-server me-1"></i>
													<?php echo e($connection->api_endpoint ?? 'No endpoint configured'); ?>
									...
									<td class="py-3 px-4">
										<span class="badge bg-info bg-opacity-10 text-info fs-6 px-3 py-2">
											<i class="fas fa-layer-group me-1"></i><?php echo e(ucfirst($connection->connection_type)); ?>

										</span>
									</td>
									<td class="py-3 px-4">
										<span class="badge <?php echo e($connection->is_active ? 'bg-success' : 'bg-secondary'); ?> fs-6 px-3 py-2">
											<i class="fas <?php echo e($connection->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?> me-1"></i>
											<?php echo e($connection->is_active ? 'Active' : 'Inactive'); ?>
									...
									<td class="py-3 px-4">
										<small class="text-muted">
											...
											<?php echo e($connection->updated_at ? $connection->updated_at->diffForHumans() : 'Never'); ?>

										</small>
									</td>
									<td class="py-3 px-4 text-center">
										<div class="btn-group" role="group">
											<a href="<?php echo e(route('whatsapp.connections.show', $connection)); ?>" class="btn btn-outline-primary btn-sm me-2">
												<i class="fas fa-eye me-1"></i>View
											</a>
											<a href="<?php echo e(route('whatsapp.connections.edit', $connection)); ?>" class="btn btn-outline-warning btn-sm">
				...
				<?php if(method_exists($connections, 'links')): ?>
			...
			<?php else: ?>
				<div class="text-center py-5">
					<div class="empty-state">
						...
						<a href="<?php echo e(route('whatsapp.connections.create')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layout.wrapper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/connections/index.blade.php ENDPATH**/ ?>