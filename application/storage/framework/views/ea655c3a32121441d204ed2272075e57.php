...
<ul class="nav nav-tabs profile-tab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_notes'] ?? ''); ?>"
            ...
            data-loading-target="embed-content-container"
            data-dynamic-url="<?php echo e(url('clients')); ?>/<?php echo e($client->client_id); ?>/expectativas"
            data-url="<?php echo e(_url('/clients')); ?>/<?php echo e($client->client_id); ?>/client-expectativas"
            href="#clients_ajaxtab" role="tab"><?php echo e(cleanLang(__('lang.expectativas'))); ?></a>
    </li>
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_notes'] ?? ''); ?>"
            id="tabs-menu-feedback" data-toggle="tab" data-loading-class="loading-tabs"
            data-loading-target="embed-content-container"
            data-dynamic-url="<?php echo e(url('clients')); ?>/<?php echo e($client->client_id); ?>/feedback"
            data-url="<?php echo e(_url('/clients')); ?>/<?php echo e($client->client_id); ?>/client-feedback"
            href="#clients_ajaxtab" role="tab"><?php echo e(cleanLang(__('lang.feedback'))); ?></a>
    </li>
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_notes'] ?? ''); ?>"
            id="tabs-menu-clientai" data-toggle="tab" data-loading-class="loading-tabs"
            data-loading-target="embed-content-container"
            data-dynamic-url="<?php echo e(url('clients')); ?>/<?php echo e($client->client_id); ?>/clientai"
            data-url="<?php echo e(url('clients')); ?>/<?php echo e($client->client_id); ?>/client-clientai"
            href="#clients_ajaxtab" role="tab"><i class="fas fa-wand-magic-sparkles text-warning mr-2"></i><?php echo e(cleanLang(__('lang.clientai'))); ?></a>
    </li>

    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent10'); ?>

</ul><?php /**PATH /home/tasklist/public_html/application/resources/views/pages/client/components/misc/topnav.blade.php ENDPATH**/ ?>