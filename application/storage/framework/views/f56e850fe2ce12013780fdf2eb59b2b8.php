		...
		<div class="col-lg-8">
			<div class="card border-0 shadow-sm">
				...
				<div class="card-body p-4">
					<form action="<?php echo e(route('whatsapp.tags.store')); ?>" method="POST" id="tagForm">
						<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
									id="color" name="color" value="<?php echo e(old('color', '#6c757d')); ?>" required>
								<input type="text" class="form-control" value="<?php echo e(old('color', '#6c757d')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
								...
								placeholder="Optional description of this tag"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layout.wrapper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/tags/create.blade.php ENDPATH**/ ?>