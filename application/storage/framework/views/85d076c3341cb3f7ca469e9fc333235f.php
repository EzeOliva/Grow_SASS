...
<ul class="nav nav-tabs profile-tab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_notes'] ?? ''); ?>"
            ...
            href="#clients_ajaxtab" role="tab"><i class="fas fa-robot mr-2"></i><?php echo e(cleanLang(__('lang.clientai'))); ?></a>
    </li>

    <!--[MODULES] - dynamic menu-->
    <?php echo config('modules.menus.tabs.client.parent10'); ?>

</ul><?php /**PATH D:\my_apache\application\resources\views/pages/client/components/misc/topnav.blade.php ENDPATH**/ ?>