...
<div class="container-fluid">
	<div class="row page-titles">
		...
		<div class="col-md-6 text-right">
			<a href="<?php echo e(route('whatsapp.line-configs.index')); ?>" class="btn btn-outline-secondary">
	...
	<div class="card">
		<div class="card-body">
			<form method="POST" action="<?php echo e(route('whatsapp.line-configs.store')); ?>">
				<?php echo csrf_field(); ?>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="connection_id" class="form-select" required>
								...
								<?php $__currentLoopData = $connections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $connection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($connection->id); ?>"><?php echo e($connection->name); ?> (<?php echo e($connection->phone_number); ?>)</option>
...
<?php echo $__env->make('layout.wrapper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/line-configs/create.blade.php ENDPATH**/ ?>