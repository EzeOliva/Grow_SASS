        ...
        <div class="table-responsive list-table-wrapper min-h-400">
            ...
            <table id="invoices-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <tbody id="invoices-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.invoices.components.table.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH D:\my_apache\application\resources\views/pages/invoices/components/table/table.blade.php ENDPATH**/ ?>