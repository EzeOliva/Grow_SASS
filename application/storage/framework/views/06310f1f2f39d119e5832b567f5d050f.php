...
<!--main content -->
<!--GENERAL CHECKOUT JS-->
<script src="public/js/landlord/frontend/account.js?v=<?php echo e(config('system.versioning')); ?>"></script><?php /**PATH D:\Grow_SaaS\application\resources\views/account/wrapper.blade.php ENDPATH**/ ?>