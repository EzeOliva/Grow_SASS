    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar" style = "align-items: center">
                ...
                <!-- WhatsApp Tickets -->
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-dark font-22 p-t-10 p-r-10" href="<?php echo e(url('/whatsapp/tickets')); ?>"
...
</header><?php /**PATH E:\GrowSass\application\resources\views/nav/topnav.blade.php ENDPATH**/ ?>