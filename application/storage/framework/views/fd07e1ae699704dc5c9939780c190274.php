    ...
    <div class="row page-titles">
        <div class="col-md-6">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0"><?php echo e($connection->connection_name); ?></h4>
                    <p class="text-muted mb-0">Connection Details</p>
                </div>
            </div>
        </div>
        <div class="col-md-6 text-right">
            <a href="<?php echo e(route('whatsapp.connections.edit', $connection)); ?>" class="btn btn-primary">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p><?php echo e($connection->connection_name); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="fw-bold">Type:</label>
                                <p><span class="<?php echo e($connection->type_badge_class); ?>"><?php echo e(ucfirst($connection->connection_type)); ?></span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <p><span class="<?php echo e($connection->status_badge_class); ?>"><?php echo e(ucfirst($connection->status)); ?></span></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <?php if($connection->phone_number): ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="fw-bold">Phone Number:</label>
                                    <p><?php echo e($connection->phone_number); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                    
                    <?php if($connection->last_connected_at): ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="fw-bold">Last Connected:</label>
                                    <p><?php echo e($connection->last_connected_at->format('M d, Y H:i:s')); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                    
                    <?php if($connection->error_message): ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="fw-bold text-danger">Last Error:</label>
                                    <p class="text-danger"><?php echo e($connection->error_message); ?></p>
                                    <?php if($connection->last_error_at): ?>
                                        <small class="text-muted">Error occurred at: <?php echo e($connection->last_error_at->format('M d, Y H:i:s')); ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <?php if($connection->status === 'connected'): ?>
                            <form action="<?php echo e(route('whatsapp.connections.disconnect', $connection)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('whatsapp.connections.connect', $connection)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php if($connection->connection_type === 'baileys'): ?>
                            <button type="button" class="btn btn-info w-100" onclick="showQRCode(<?php echo e($connection->id); ?>)" id="qrCodeBtn<?php echo e($connection->id); ?>">
                                <i class="fas fa-qrcode me-2"></i>Show QR Code
                            </button>
                        <?php endif; ?>
                        
                        <a href="<?php echo e(route('whatsapp.connections.edit', $connection)); ?>" class="btn btn-outline-primary w-100">
                            <i class="fas fa-edit me-2"></i>Edit Connection
                        </a>
                        
                        <form action="<?php echo e(route('whatsapp.connections.destroy', $connection)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.wrapper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/connections/show.blade.php ENDPATH**/ ?>