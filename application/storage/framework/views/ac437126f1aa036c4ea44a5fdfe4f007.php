<div class="table-responsive">
    ...
    <table id="demo-email-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
        ...
        <tbody id="emails-td-container">
            <!--ajax content here-->
            <?php echo $__env->make('pages.settings.sections.email.queue.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <!--ajax content here-->
        </tbody>
        <tfoot>
            <tr>
...
<?php endif; ?><?php /**PATH D:\my_apache\application\resources\views/pages/settings/sections/email/queue/table.blade.php ENDPATH**/ ?>