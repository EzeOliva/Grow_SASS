...
<div class="messages-page-container">
    ...
    <div class="messages-content">
        <div id="messages-content-container">
            <?php if(isset($thread)): ?>
                <!-- Thread Content -->
                <?php echo $__env->make('pages.messages.components.chat-room', ['thread' => $thread], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php else: ?>
                <!-- Welcome State - Beautiful Design -->
                <?php echo $__env->make('pages.messages.components.welcome-state', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
        </div>
    </div>
</div>
...
function loadMessagesJS() {
    ...
    searchScript.src = '/public/js/core/messages-search.js?v=<?php echo e(config('system.versioning')); ?>';
    searchScript.onload = function() {
        // Load main messages script after search script loads
        const script = document.createElement('script');
        script.src = '/public/js/core/messages.js?v=<?php echo e(config('system.versioning')); ?>';
...
<?php echo $__env->make('layout.wrapper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/pages/messages/wrapper.blade.php ENDPATH**/ ?>