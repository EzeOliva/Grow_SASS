        ...
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="contracts-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contract-list"
                ...
                <tbody id="contracts-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.contracts.components.table.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH /home/tasklist/public_html/application/resources/views/pages/contracts/components/table/table.blade.php ENDPATH**/ ?>