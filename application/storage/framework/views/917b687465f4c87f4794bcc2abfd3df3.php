...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-6 text-right">
            <a href="<?php echo e(route('whatsapp.connections.index')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('whatsapp.connections.store')); ?>" method="POST" id="connection-create-form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('connection_name')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="baileys" <?php echo e(old('connection_type') == 'baileys' ? 'selected' : ''); ?>>Baileys (WhatsApp Web)</option>
                                        <option value="twilio" <?php echo e(old('connection_type') == 'twilio' ? 'selected' : ''); ?>>Twilio</option>
                                        <option value="360dialog" <?php echo e(old('connection_type') == '360dialog' ? 'selected' : ''); ?>>360dialog</option>
                                        <option value="gupshup" <?php echo e(old('connection_type') == 'gupshup' ? 'selected' : ''); ?>>Gupshup</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="<?php echo e(old('connection_data.account_sid')); ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" 
                                               ...
                                               value="<?php echo e(old('connection_data.auth_token')); ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="<?php echo e(old('connection_data.api_key')); ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" 
                                               ...
                                               value="<?php echo e(old('connection_data.webhook_secret')); ?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="<?php echo e(old('connection_data.app_name')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('webhook_config.webhook_url')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('webhook_config.webhook_secret')); ?>"
...
<?php echo $__env->make('layout.wrapper', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/connections/create.blade.php ENDPATH**/ ?>