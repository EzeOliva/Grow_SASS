...
<aside class="left-sidebar settings-menu">
    ...
    <div class="scroll-sidebar" id="settings-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="settings-sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="javascript:void(0);" data-url="/settings/feedback"
                                ...
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.feedback'))); ?></a>
                        </li>
                        <!--[MODULES] - dynamic menu-->
                ...
                <li class="sidenav-menu-item <?php echo e($page['settingsmenu_permissions'] ?? ''); ?>">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
                        id="settings-menu-permissions">
                        <span class="hide-menu"><?php echo e(cleanLang(__('lang.settings_permissions'))); ?>
                    ...
                    <a href="javascript:void(0);" data-url="/app/settings/permissions/modules" id="settings-menu-permissions-modules"
                        class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.available_modules'))); ?></a>
                </li>
                <li>
                    <a href="javascript:void(0);" data-url="/app/settings/permissions/roles" id="settings-menu-permissions-roles"
                        class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.role_permissions'))); ?></a>
                </li>
                <li>
                    <a href="javascript:void(0);" data-url="/app/settings/permissions/whatsapp" id="settings-menu-permissions-whatsapp"
                        class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.whatsapp_permissions'))); ?></a>
                </li>
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.permissions'); ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH E:\GrowSass\application\resources\views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>