...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <!--ADD NEW ITEM-->
        <?php if(auth()->user()->role->role_expectation >= 2): ?>
        <button type="button"
...
</div><?php /**PATH /home/tasklist/public_html/application/resources/views/pages/expectation/components/misc/list-page-actions.blade.php ENDPATH**/ ?>