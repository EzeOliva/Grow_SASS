<!DOCTYPE html>
<html lang="en" class="<?php echo e(auth()->check() ? (auth()->user()->type ?? '') : ''); ?> <?php echo e(config('visibility.page_rendering')); ?> <?php echo e(config('active_theme')); ?>">

<!--CRM - GROWCRM.IO-->
<?php echo $__env->make('layout.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<body id="main-body"
    class="loggedin fix-header card-no-border fix-sidebar <?php echo e(config('settings.css_kanban')); ?> <?php echo e(auth()->check() ? runtimePreferenceLeftmenuPosition(auth()->user()->left_menu_position) : ''); ?> <?php echo e($page['page'] ?? ''); ?>">
...
</html><?php /**PATH E:\GrowSass\application\resources\views/layout/wrapper.blade.php ENDPATH**/ ?>