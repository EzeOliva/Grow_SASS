        ...
        <div class="col-md-3">
            <div class="whatsapp-card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-primary"><?php echo e($kpis['total_tickets'] ?? 0); ?></h3>
        ...
        <div class="col-md-3">
            <div class="whatsapp-card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-warning"><?php echo e($kpis['open_tickets'] ?? 0); ?></h3>
        ...
        <div class="col-md-3">
            <div class="whatsapp-card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-info"><?php echo e($kpis['in_progress_tickets'] ?? 0); ?></h3>
        ...
        <div class="col-md-3">
            <div class="whatsapp-card text-center">
                <div class="card-body">
                    ...
                    <h3 class="text-success"><?php echo e($kpis['closed_tickets'] ?? 0); ?></h3>
            ...
            <div class="whatsapp-card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6">
                            <h4 class="text-primary"><?php echo e($kpis['avg_first_response_time'] ?? 0); ?></h4>
                            <p class="text-muted mb-0">Avg First Response (min)</p>
                        </div>
                        <div class="col-6">
                            <h4 class="text-success"><?php echo e($kpis['avg_resolution_time'] ?? 0); ?></h4>
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="whatsapp-card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-4">
                            <h4 class="text-primary"><?php echo e($kpis['total_messages'] ?? 0); ?></h4>
                            <p class="text-muted mb-0">Total Messages</p>
                        </div>
                        <div class="col-4">
                            <h4 class="text-info"><?php echo e($kpis['client_messages'] ?? 0); ?></h4>
                            <p class="text-muted mb-0">Client Messages</p>
                        </div>
                        <div class="col-4">
                            <h4 class="text-success"><?php echo e($kpis['agent_messages'] ?? 0); ?></h4>
        ...
        <div class="col-md-6">
            <div class="whatsapp-card">
                ...
                <div class="card-body">
                    <div id="agentRanking">
                        <?php if(isset($kpis['top_agents']) && count($kpis['top_agents']) > 0): ?>
                            <?php $__currentLoopData = $kpis['top_agents']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="d-flex align-items-center">
                                        <span class="badge bg-primary me-2"><?php echo e($index + 1); ?></span>
                                        <span class="fw-semibold"><?php echo e($agent['name']); ?></span>
                                    </div>
                                    <span class="badge bg-success"><?php echo e($agent['tickets_resolved']); ?> tickets</span>
                                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-6 col-sm-4 col-md-3 text-center mb-3">
                    <a href="<?php echo e(route('whatsapp.tickets.create')); ?>" class="text-decoration-none">
                ...
                <div class="col-6 col-sm-4 col-md-3 text-center mb-3">
                    <a href="<?php echo e(route('whatsapp.tickets.index')); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow">
                ...
                <div class="col-6 col-sm-4 col-md-3 text-center mb-3">
                    <a href="<?php echo e(route('whatsapp.connections.index')); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow">
                ...
                <div class="col-6 col-sm-4 col-md-3 text-center mb-3">
                    <a href="<?php echo e(route('whatsapp.reporting.index')); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow">
                ...
                <div class="col-6 col-sm-4 col-md-3 text-center mb-3">
                    <a href="<?php echo e(route('whatsapp.line-configs.index')); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow">
                ...
                <div class="col-6 col-sm-4 col-md-3 text-center mb-3">
                    <a href="<?php echo e(route('whatsapp.tags.index')); ?>" class="text-decoration-none">
                        <div class="p-3 border rounded hover-shadow">
...
document.addEventListener('DOMContentLoaded', function(){
    var kpis = <?php echo json_encode($kpis ?? [], 15, 512) ?>;
...
<?php echo $__env->make('whatsapp.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/dashboard/index.blade.php ENDPATH**/ ?>