        ...
        <div class="table-responsive">
            ...
            <table class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                ...
                <tbody id="projects-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.templates.projects.components.table.ajax', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH /home/tasklist/public_html/application/resources/views/pages/templates/projects/components/table/table.blade.php ENDPATH**/ ?>