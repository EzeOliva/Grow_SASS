<?php $__env->startSection('title', 'Create New Ticket'); ?>
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('whatsapp.dashboard')); ?>">WhatsApp</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('whatsapp.tickets.index')); ?>">Tickets</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="ticket-create-form" method="POST" action="<?php echo e(route('whatsapp.tickets.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <option value="whatsapp" <?php echo e(old('channel') == 'whatsapp' ? 'selected' : ''); ?>>WhatsApp</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control <?php $__errorArgs = ['initial_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              required><?php echo e(old('initial_message')); ?></textarea>
...
<?php echo $__env->make('whatsapp.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\GrowSass\application\resources\views/whatsapp/tickets/create.blade.php ENDPATH**/ ?>