...
<tr id="contact_<?php echo e($contact->id); ?>">
    ...
    <td class="contacts_col_first_name" id="contacts_col_first_name_<?php echo e($contact->id); ?>">
        ...
        <a href="javascript:void(0);" class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form user_profile_name_<?php echo e($contact->id); ?>"
...
<!--each row--><?php /**PATH /home/tasklist/public_html/application/resources/views/pages/contacts/components/table/ajax.blade.php ENDPATH**/ ?>